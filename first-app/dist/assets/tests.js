...
define('first-app/tests/test-helper', ['first-app/app', 'first-app/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('first-app/tests/unit/routes/test-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('first-app/tests/unit/routes/test/new-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
